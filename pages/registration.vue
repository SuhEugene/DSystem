  ...
  <section>
    <transition-group class="steps" name="swipe">
      ...
      <div :key="2" v-if="step == 2" class="step">
        <div class="minimizer">
          <div class="heading">Как тебя зовут?</div>
          <div class="input">
            <input
              v-model="username"
      ...
      <div :key="4" v-if="step == 4" class="step">
        <div class="minimizer">
          ...
          <p style="margin-bottom: 10px;">В банке производятся операции с деньгами и, следовательно, чем сложнее пароль, тем меньше шанс оказаться взломанным<br><span class="grey">P.S. Нет, ну реально! <span :class="{'red': password == '123123'}">123123 не подходит!</span> Будь креативнее!</span></p>
      ...
      <div :key="6" v-if="step == 7" class="step">
