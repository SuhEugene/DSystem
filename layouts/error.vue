<template>
  <div class="container console">
    ...
    <span v-if="this.insert >= strings.length">
      ...
      <br>
      <br>
      <span class="grey">guest@diamond:~$</span>
      <b>{{(cursor) ? "_" : ""}}</b>
    </span>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    strings: [
      "<span class='grey'>guest@diamond:~$</span> npm run app",
      "",
      "> diamond@2.0 app /home",
      "> nuxt start",
      "",
      "Initializing app...",
      "Waiting for server...",
      ...
      "",
      "<span class='grey'>guest@diamond:~$</span> bash gotohomepage.sh",
      ""
    ],
    insert: 0,
    cursor: false
